...
// ! array_name.at[negative index] is mthod ki help se python jesi negative index achieve kar sakte hei java script mei
...
// {
//   console.log(item);//*pure items dedega humko ye to
// }
...
//   console.log(fruits[item]);//*isse item milege

//   console.log(item);//*isse isse sirf index milege
...
// * below method will give proper expected result 
...
// *here below method will give answer undefined in case of for each that is the difference between map and for each method.
...
// forEach method kuch return nahi kar sakta hei uske scope ke bahr bas usi array mei khelne deta hei
...
// const myForEachArr=fruits.map((currEle,index, arr) => {
//   return `${currEle} ${index}`; //![ 'apple 0', 'orange 1', 'mango 2', 'grapes 3', 'banana 4' ]!//
// });

// //!New array banadia idhr to original array ko change nahi karega ye nyaa array banata hei 
...
// This is the only big difference between  map and froEach

//Below is the scenario when some operations are performed on map and forEach
...
// console.log(doubleValue);//[ 2, 4, 6, 8, 10 ] new array generated
...
// console.log(fruits.unshift("puppy"));
// console.log(fruits);
...
// // fruits.splice(0, fruits.length, "grapes","pinky","chinky");
// // console.log(fruits);

// // //! what if you want to add the element at the end

// fruits.splice(fruits.length-1, fruits.length-1, "grapes");
...
//?1: indexOf Method: The indexOf method returns the first index at which a given element can be found🏃‍♀️(❁´◡`❁) in the array, or -1 if it is not present.
...
//*fromindex mei index ayega jiske baad se dhundna satrt karna hei milgea uske baad to output uska index ayega jispe dhund rhe h jo bo h nahi to -1 ayega
...
//? ye method tab kaam ati hei jab koi element array mei multiple  times araha ho esa hai bhaiya 
...
// const numbers = [1, 2, 3, 6, 4, 5, 6, 7, 8, 9];
// const result = numbers.includes(5,6);
// console.log(result);
...
// t=months.splice(months.length,0, "Dec");

// console.log(months);

// console.log(t);

// Empty array return karegi splice method jab hum add kar rahee honge  element array mei 
...
// // 4
// Any specific position se delete ya change karna hoto ese kar skte hei
// const indexToDel= months.indexOf("June");
// months.splice(indexToDel,1S);
// console.log(months);
...
//ye sirf index deta hei matched value ka
...
//   return curElem !== value;//element of array jo jo value ke equal nahi hei un sabhi ko dedo 
// });
...
// let filtered=  products.filter((element)=> element.price<=5000)
// console.log(filtered)



// //! Filter unique values
// const numbers = [1, 2, 3, 4, 6,6,7,0,4, 5, 6, 7, 8, 9];
...
//Same ascending descending concept for no. and string both
...
// console.log(result);////squared new array
// console.log(numbers)////not changed
...
// Upar jo hua usko chaining bolte hei 

//   filter method undefined ko hata dega 
...
// initialValhue (optional): An initial value for the accumulator. If not provided, the first element of the array is used as the initial accumulator value.
...
const average= totalPrice/productPrice.length
console.log(average);