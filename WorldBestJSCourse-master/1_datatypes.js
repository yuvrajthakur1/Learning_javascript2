...
var badMemories = null;
console.log(badMemories);
console.log(typeof null);// object bug h bhai
...
console.log(typeof Number(myFavNum));//method
...
//? ANS:- Because nan can be a sequence of simple character and can be of special character.
// if (NaN == NaN) {
